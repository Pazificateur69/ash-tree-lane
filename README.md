...
| Invert the mouse | `I` | |
| Take a still with the camcorder | `C` (the stills end up in the journal) | |
| Settings | `O` or the button top right: sensitivity, field of view, volume, subtitle size, a calm mode with less shaking and grain, a frame counter | the button top right |
| Gamepad | left stick walks, right stick looks, A takes, X jumps, RB takes a still, Y opens the journal, B closes it | |
...
A full walk takes twenty to forty minutes. Progress is kept in your own browser only (no account, no cookies, no tracking), so you can leave and come back; the house remembers what you found and keeps its doors open. If you stand still too long without knowing where to go, the house murmurs a hint. If you would rather not play, **or just read** on the title page opens the journal complete. Come back after the ending and the house is not quite the same.

Headphones are worth it. The drone, the growl, the burning pages and the voices on the tapes are synthesized in the browser (the voices are a buzz through moving vowel formants, run through a tape or a radio: you hear someone talking and cannot quite make them out); the footsteps that echo late in the hallway, the creak of a door that was not there and the wind at the windows are recordings. Everything is placed in 3D around your head (HRTF): the growl comes from one side and moves round you, and sometimes something breathes just behind you. The Great Hall is almost silent, with no echo at all.

## What happens, in order (light spoilers)

1. **The house.** Foyer, kitchen, living room, two bedrooms, the yard under the stars through the windows. A trunk that is not theirs holds the story of how the papers were found. Tapes, a tape measure, a photograph face down and a specimen bag hold the first chapters: the move, the quarter of an inch, the hallway, Karen, and what the laboratory made of the walls. Delial is on the coffee table, and the dog and the cat have left prints.
2. **A quarter of an inch.** Take the tape measure and measure the house yourself: from the pencil mark inside, then the same wall from outside the children's window. The numbers do not agree. Then a door appears between the bedrooms. Behind it, a closet that was never there, and a tape labeled 5½.
...
7. **The house closes.** Read the rescue and go home: the walls lean in, the ceiling comes down, doors slam, the lamps go one by one, and the front door opens outward for the first time. Get out. Tom's light crosses the living room behind you, and falls. Tom does not come up. Back home, your watch and Tom's no longer agree.
...
10. **Karen goes in.** You are her now, walking into the dark with a flashlight toward the light at the end, calling his name.
11. **Vermont.** Snow at the window, the children's drawings on the wall, Reston's chair, and the finished film on the table. Then the list of whatever you left in the house, a card to share with your last still, and at the back of the journal Exploration #6 (your own: how deep you went, how long you were in the dark, how many times you turned round, Johnny's notes on it, and your stills), the letters, the exhibits, the index, and a page for those who went into the well.

## The journal

The journal is the book side of the project: a retelling of the novel in new words, in the novel's structure. Twenty-six pages (the chapters, an introduction, the Whalestoe letters, an appendix of exhibits and contrary evidence, an Exploration #6 written by your own walk, a page you only get one way, and an index) and thirty-seven notes.
...
**Rendering.** The flashlight is a spotlight with a projected cookie, and it casts soft (VSM) shadows from every wall, every piece of furniture and every instanced tile of the labyrinth. It closes its iris when the wall is close, the way a camcorder does, and dips when the house growls. A post-processing chain adds bloom to the lamps, the lantern and the television, film grain, a vignette, a breath of chromatic aberration at the edges and, once the house has moved, the tracking tear of a worn tape: the Hi8 look. The camera is held in a hand, not on a tripod. Dust drifts in the beam; your breath shows in the cold of the hallway. The hallway's gray uses world-space texture coordinates, so its tiles have no seams, and the labyrinth is built in chunks so that what is behind you is not drawn. Everything in the house that never moves on its own (walls, frames, skirting, furniture built from boxes, lamp shades, trees) is baked into one mesh per material, so the whole house is about fifteen draw calls; when a door appears or the house moves, it is baked again. Only the four light sources nearest to you are real point lights, whichever they are. The dust is one small cloud that wraps around wherever you stand. The shadow map is redrawn only when the camera has moved, the bloom runs at half resolution, the far plane sits just behind the fog, and the textures and props are shared and decimated to what the light can show. The pixel ratio follows the frame rate (bloom off first, then fewer pixels, then a smaller shadow map), and a **Detail** button in the corner does the same by hand; touch devices start low.
...
assets/textures/    PBR materials, labels, pages, the flashlight cookie; low/ holds half size copies
assets/models/      glTF models (optimized)
assets/sky/         the night panorama and its HDR twin
vendor/three/       three.js r170, the addons the house imports and the meshopt decoder
...
assets/CREDITS.md   every asset, its author, source and license
tools/walk.mjs      the headless walkthrough, from the tape measure to Vermont (playwright-core)
...
Any static server will do; a plain `file://` open will show the title page and the journal but will not open the door, because three.js is imported as a module through an import map.
...
*Ash Tree Lane* est un hommage non officiel à *La Maison des feuilles* de Mark Z. Danielewski (traduction française de Claro, Denoël). Au lieu de lire l'histoire, on la parcourt : une maison en 3D à la première personne, où chaque objet trouvé débloque un chapitre du carnet, et où la maison réagit à ce qu'on lit. Le texte est une réécriture, jamais le texte du roman. Tout est fait en HTML, CSS et JavaScript, avec three.js pour la maison : matériaux PBR photographiés et modèles glTF (lit, cuisine, canapé, radio, magnétophone), sons enregistrés, ombres portées par la lampe torche, grain et bloom d'un caméscope Hi8, ciel étoilé aux fenêtres, sons synthétisés, labyrinthe généré. On mesure la maison soi-même, on finit dans la peau de Karen, et l'épilogue dans le Vermont se joue. Vingt-six pages, trente-sept notes, les lettres, les pièces à conviction, une Exploration #6 écrite par votre partie, et un index. Réglages (sensibilité, champ de vision, mode calme), son 3D au casque, et une version allégée pour les téléphones. Gratuit, et ça le restera. Le site est en anglais parce qu'il est destiné à l'auteur.
